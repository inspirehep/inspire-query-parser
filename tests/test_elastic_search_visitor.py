...
def test_regression_parenthesized_date_query_with_year():
    query_string = "(jy 2013 or jy 2014)"
    expected_es_query = {
        "bool": {
            "should": [
                {
                            ...
                            "bool": {
                                "should": [
                                    ...
                                    },
                                    {
                                        "match": {
                                            "_all": {
                                                "query": "publication_info.year:2013",
                                                "operator": "and",
                                            }
                                        }
                                    },
                            ...
                            "bool": {
                                "should": [
                                    ...
                                    },
                                    {
                                        "match": {
                                            "_all": {
                                                "query": "publication_info.year:2014",
                                                "operator": "and",
                                            }
                                        }
                                    },
    ...
    generated_es_query = _parse_query(query_string)
    assert _parse_query(query_string) == _parse_query("jy 2013 or jy 2014")
    assert generated_es_query == expected_es_query


def test_regression_parenthized_query_with_months():
